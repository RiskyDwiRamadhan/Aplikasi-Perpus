...
<div id="content">
	<p id="tombol-tambah-container">
        ...
        <a target="_blank" href="pages/cetak_pengembalian.php"><img src="print.png" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor/pengembalian_pdf.php"><img src="pdf.png" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor/pengembalian_excel.php"><img src="excel.png" height="50px" height="50px"></a> 
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST") { 
                    ...
                    if($pencarian != "") { 
                        ...
                        $query = "SELECT tbtransaksi.idtransaksi, tbanggota.nama, tbbuku.judul, tbtransaksi.tglpinjam, 
                                ...
                                INNER JOIN tbanggota ON tbtransaksi.idanggota = tbanggota.idanggota
                                INNER JOIN tbbuku ON tbtransaksi.idbuku = tbbuku.idbuku
                                WHERE tbtransaksi.status_transaksi = 'Kembali'
								ORDER BY tbtransaksi.idtransaksi DESC 
								LIMIT $posisi, $batas"; 
                        $queryJml = "SELECT * FROM tbtransaksi WHERE tbtransaksi.status_transaksi = 'Kembali'"; 
                        $no = $posisi * 1; 
                    }
                }
                else { 
